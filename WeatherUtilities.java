//Here, we perform tasks with our WeatherEntry objet. 
...
public class WeatherUtilities{
  ...
  //The goal is to compare OPP to other more basic methods. 
  ...
  //Our main method will take input from the user and record the data to create an array of
